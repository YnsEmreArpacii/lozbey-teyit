...
client.on('userUpdate', async user => {
  let sunucuid = "807185038448787466"; //Buraya sunucunuzun IDsini yazın
  let tag = "ቐ"; //Buraya tagınızı yazın
  let rol = "807262640979836958"; //Buraya tag alındığı zaman verilecek rolün IDsini yazın
  let rol2 = "807262569239937084"; //Buraya tag alındığı zaman verilecek rolün IDsini yazın
